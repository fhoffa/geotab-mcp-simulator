#!/usr/bin/env node
/*
 * Stamps index.html's app.js/styles.css/data/sample-data.js/data/conversations.js
 * tags with a ?v=<short-sha> of each file's own last commit, so GitHub Pages visitors
...
const ASSETS = ["styles.css", "data/sample-data.js", "data/conversations.js", "app.js"];
